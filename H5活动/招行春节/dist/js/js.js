...
$(function () {
    ...
    (function () {
        ...
        $(".page_affirm").click(function () {
            var $this = $(this);
            var $qrCode = $(this).find(".qr_code").addClass('dOut');
            setTimeout(function () {
                $this.hide();
        ...
        $('.close-downMask').click(function () {
            $('.immediately').hide();
            var $downAppWrap = $('.downApp-wrap').addClass('zoomOut');
            setTimeout(function () {
                $('.downMask').hide();
    ...
    (function () {
        var html = '';
        var rot_img = '';
        var arrBtn = ['点击了挥春', '点击了花鸟字', '点击了中国结', '点击了剪纸', '点击了糖画'];
        for (var i = 2; i < 19; i++) {
    ...
    (function () {
        ...
        $('.close-rule').click(function () {
            var $ruleBox = $('.rule-box').addClass('zoomOut');
            setTimeout(function () {
                $('.rule-mask').hide();
...
function func_mask(do_show, msg) {
    ...
    if (do_show) {
        ...
        var _html = '<div class="page_weui_loading_toast page_loading">' + '<div class="page_weui-toast loading">' + '<div class="page_weui-loading_box">' + '<i class="page_weui-loading"></i>' + msg_html + '</div>' + '</div>' + '</div>';
        $("body").append(_html);
    }
}
